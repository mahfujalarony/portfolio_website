...
export const metadata: Metadata = {
  ...
  description:
    "Mahfuj Alam - Full Stack Developer working at the intersection of AI, data, and scalable software systems. Explore my projects, experience, and contributions.",
  alternates: {
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            ...
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contact Mahfuj Alam"
              >
